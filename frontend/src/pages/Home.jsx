    ...
    return (
        <>
            <div className="bg-[#F0F0F0] h-full">
                <Navbar />
                {/* <div className="bg-[#88C3FF] h-[95px] bg-opacity-80">

                </div> */}
                <div className="h-60 md:h-[500px] lg:h-[700px]  xl:h-[780px] bg-cover lg:bg-center xl:bg-center" style={{ backgroundImage: 'url("./assets/DashBoard.jpg")' }}>
                    <div className="pl-[80px] pt-[220px] ">
                        ...
                        <div className="text-[#0e2e50] font-semibold pt-4 font-roboto text-2xl">
                            <p>"Kami melayani masyarakat yang ingin menyewa fasilitas pemerintah"</p>
