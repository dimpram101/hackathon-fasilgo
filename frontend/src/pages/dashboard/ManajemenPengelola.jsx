        ...
        <table className="w-full text-sm text-left text-gray-500">
          <thead className="text-xs text-gray-700 bg-blue-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-midle">
                Foto KTP
              </th>
              <th scope="col" className="px-6 py-3">
          ...
          <tbody>
            <tr className="bg-white border-b ">
              ...
              <td className="px-6 py-4">djibranscout@gmail.com</td>
              <td className="px-6 py-4">082150667710</td>
            ...
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-4">dimpramgeming@gmail.com</td>
              <td className="px-6 py-4">082150776601</td>
              <td className="px-6 py-4 text-center">
                <a
                  href="#"
                  className="font-medium text-blue-600 hover:underline"
            ...
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-4">agoy130303@gmail.com</td>
              <td className="px-6 py-4">085248085253</td>
              <td className="px-6 py-4 text-center">
                <a
                  href="#"
                  className="font-medium text-blue-600 hover:underline"
