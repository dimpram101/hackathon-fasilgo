      ...
      <div className="flex flex-row gap-2 items-center">
        ...
        {msg && (
          <h2 className="text-green-500 font-bold text-sm">
            Berhasil membuat akun, silahkan menempatkan akun tersebut pada fasilitas! <Link to={"/dashboard/manajemen-fasilitas"} className="underline font-bold">di sini</Link>
          </h2>
        )}
      </div>
